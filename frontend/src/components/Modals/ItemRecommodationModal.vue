  ...
  <template #body-title>
    ...
    <template #body-content>
      ...
      <div v-if="!attributes || !Object.keys(attributes).length">
        ...
        <div v-if="attributes && Object.keys(attributes).length">
          <h3 class="text-xl font-medium  text-gray-900 mt-6">Valuable Insights:</h3><br/>
          <ul>
         ...
         <h3 class="text-xl font-medium  text-gray-900 mt-6">Recommended Items:</h3><br/>
      
        <div v-if="!attributes || !attributes.items || !attributes.items.length">
          <p class="text-gray-500">No recommended items available.</p><br/>
          <div class="flex justify-center">
            <Button variant="solid" @click="createNewItem">Create Item</Button>
          </div>
        </div>
        <div v-if="attributes && attributes.items && attributes.items.length">
          <ul>
